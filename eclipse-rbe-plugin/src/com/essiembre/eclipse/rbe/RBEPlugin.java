...
public class RBEPlugin extends AbstractUIPlugin {
   ...
   public void start(BundleContext context) throws Exception {
      ...
      final Bundle pluginBundle = context.getBundle();

      if (pluginBundle instanceof EquinoxBundle bundle) {

         _version = bundle.getVersion();
      }
   }
    ...
    *           the key for which to fetch a localized text
    * @param args
    *           runtime arguments to replace in key value
    * 
    * @return localized string corresponding to key
    */

...
public final class PropertiesGenerator {
   ...
   private static final String[] CONTENT_LINE_SEP         = new String[3];
   static {
      CONTENT_LINE_SEP[RBEPreferences.NEW_LINE_UNIX] = "\\\\n";
      CONTENT_LINE_SEP[RBEPreferences.NEW_LINE_WIN] = "\\\\r\\\\n";
      CONTENT_LINE_SEP[RBEPreferences.NEW_LINE_MAC] = "\\\\r";
   }
      ...
      for (Iterator<String> iter = bundle.getKeys().iterator(); iter.hasNext();) {
         ...
         if (value != null) {
            ...
            if (RBEPreferences.getForceNewLineType()) {
               value = value.replaceAll("\r\n|\r|\n", CONTENT_LINE_SEP[RBEPreferences.getNewLineType()]);
            } else {
...
//        text.append(key);
    ...
    */
   private static void saveText(StringBuffer buf,
                                String str,
                                String escapeChars) {
   ...
   public static String getGeneratedBy() {
      ...
      if (GENERATED_BY == null) {
         ...
         final String generatedBy = "# Generated by " + PropertiesGenerator.class.getName() + " - " + now.toString();

         final RBEPlugin plugin = RBEPlugin.getDefault();

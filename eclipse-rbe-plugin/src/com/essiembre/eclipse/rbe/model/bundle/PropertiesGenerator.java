...
public final class PropertiesGenerator {
   ...
   public static final String  GENERATED_BY             = "#Generated by ResourceBundle Editor (http://essiembre.github.io/eclipse-rbe/)";
...
//   private static final String   SYSTEM_LINE_SEP          = Platform.getPreferencesService().getString("org.eclipse.core.runtime",
//         "line.separator",
...
//         null);
   ...
   public static String generate(Bundle bundle) {
      ...
      if (headComment != null && headComment.length() > 0) {
         if (RBEPreferences.getShowGenerator() && !headComment.startsWith(GENERATED_BY)) {
